...
import dwr.tablica.api2.ZTMApiDownload.Models.Display_.Display;
import dwr.tablica.api2.ZTMApiDownload.Models.Display_.DisplayAssembler;
import dwr.tablica.api2.ZTMApiDownload.Models.Display_.DisplayDTO;
import dwr.tablica.api2.ZTMApiDownload.Models.Display_.DisplaysRepository;
import dwr.tablica.api2.ZTMApiDownload.Models.Stop_.StopDTO;
import dwr.tablica.api2.ZTMApiDownload.Models.Stop_.StopsRepository;
...
public class  ZTMController {
    ...
    private ResponseEntity<String> getAlldisplays()  { // get info about displays (przystanki)
        ...
        displaysRepository.saveAll(gson.fromJson(ZTMRepository.getAllDisplays(), new TypeToken<List<DisplayDTO>>(){}.getType()));
    ...
    @GetMapping("/info/{displayCode}/{lineId}") // get info about departures from display (from couple of stops), only for requested line
    ...
    private ResponseEntity<String> addDepartures( @PathVariable("stopid") int stopid ) // TODO ogarnac czy nie wywoluje za duzo razy departureDTO
    {
        ...
        List<Departure> list2_objects = gson.fromJson(list, new TypeToken<List<Departure>>(){}.getType());
